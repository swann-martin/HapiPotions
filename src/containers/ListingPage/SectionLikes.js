...
const SectionLikes = props => {
  ...
  const classes = classNames(
    currentUser ? css.starIcon : css.starDisabled,
    currentLikes?.includes(listingId) ? css.iconLiked : null
  );
  ...
  return (
    <span
      ...
      onClick={() => {
        console.log('currentUser ', currentUser, 'currentLikes ', currentLikes);
    ...
    >
      <IconStar /> <span>{likes + likesOffset}</span>
    </span>
  );
};
